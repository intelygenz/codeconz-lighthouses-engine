...
type GameServiceClient interface {
	Join(ctx context.Context, in *NewPlayer, opts ...grpc.CallOption) (*NewPlayerInitialState, error)
...
func (c *gameServiceClient) Join(ctx context.Context, in *NewPlayer, opts ...grpc.CallOption) (*NewPlayerInitialState, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NewPlayerInitialState)
	err := c.cc.Invoke(ctx, GameService_Join_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gameServiceClient) Turn(ctx context.Context, in *NewTurn, opts ...grpc.CallOption) (*NewAction, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NewAction)
	err := c.cc.Invoke(ctx, GameService_Turn_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GameServiceServer interface {
	Join(context.Context, *NewPlayer) (*NewPlayerInitialState, error)
...
func (UnimplementedGameServiceServer) Join(context.Context, *NewPlayer) (*NewPlayerInitialState, error) {
